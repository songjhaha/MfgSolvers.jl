...
# solve_mfg(Problem::MFGOneDim; method=:PI_FP, node=200, N=200, maxit=80, tol=1e-8, verbose=true) = solve_mfg_1d(Problem, Val(method), node, N, maxit, tol, verbose)

function solve_mfg_1d(Problem::MFGOneDim, ::Val{:PI_FP}, node::Int64, N::Int64, maxit::Int64, tol::Float64, verbose::Bool, init_Q)
